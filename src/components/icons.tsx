...
/**
 * Inline icons. Hand-rolled instead of an icon dependency to keep the bundle
 * lean and fully offline. All share one wrapper so stroke/size stay consistent.
 */
...
/** Brand mark: a stylized dumbbell. */
