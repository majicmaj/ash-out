...
const RULES: MuscleRule[] = [
  // Cardio
  { keywords: ['run', 'jog', 'sprint', 'bike', 'cycl', 'spin', 'swim', 'row erg', 'rowing machine', 'elliptical', 'walk', 'hike', 'cardio', 'treadmill'], groups: ['cardio'] },
  // Compound / multi-group
  { keywords: ['deadlift'], groups: ['back', 'glutes', 'legs'] },
  { keywords: ['clean', 'snatch', 'thruster'], groups: ['legs', 'shoulders', 'back'] },
  // Chest
  { keywords: ['bench', 'chest press', 'chest fly', 'pec', 'push up', 'pushup', 'press up', 'dip'], groups: ['chest', 'triceps'] },
  // Back
  { keywords: ['pull up', 'pullup', 'chin up', 'chinup', 'lat pulldown', 'pulldown', 'row', 'rows'], groups: ['back', 'biceps'] },
  // Shoulders
  { keywords: ['overhead press', 'ohp', 'shoulder press', 'military press', 'lateral raise', 'front raise', 'shrug', 'arnold'], groups: ['shoulders'] },
  // Arms
  { keywords: ['curl', 'bicep'], groups: ['biceps'] },
  { keywords: ['tricep', 'pushdown', 'skullcrusher', 'kickback', 'close grip'], groups: ['triceps'] },
  // Legs / glutes
  { keywords: ['squat', 'leg press', 'lunge', 'leg extension', 'leg curl', 'calf', 'split squat', 'step up'], groups: ['legs'] },
  { keywords: ['hip thrust', 'glute', 'bridge', 'romanian', 'rdl'], groups: ['glutes', 'legs'] },
  // Core
  { keywords: ['plank', 'crunch', 'sit up', 'situp', 'ab ', 'abs', 'leg raise', 'russian twist', 'hollow'], groups: ['core'] },
]
